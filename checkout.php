...
.img-fluid1{
    ...
    max-width: 180%; height: auto; margin-right: 2px
}
.img-fluid2{
    margin: 0px 20px 0px -19px;
    max-width: 160%; height: auto;
...
@media only screen and (max-width: 460px) {
    ...
    @media only screen and (max-width: 425px) {
        ...
        .img-fluid1, .img-fluid2, .img-card
    {
        max-width: 75px;
        margin: 0px 0px 0px -27px;       
        height: auto;
                                ...
                                <center>
                                        ...
                                        <form method="GET" action="<?php echo $base_url;?>/payment-checkout.php" onsubmit="return klik()" >
                                            ...
                                            <button type="submit" class="payment pulse">
                                                ...
                                                <img src="img/card-payment.png" class="img-fluid1" >                                            
                            ...
                            <div class="col-xs-4 ">
                                ...
                                <center>
                                    <form action="<?php echo $base_url;?>/qrph-static.php">
                                        <button type="submit" class="payment pulse" >
                                            <img src="img/qrph.png" class="img-fluid2" >                                 
                                        </button> 
                                        <span>QRPh</span> 
                                    </form>                          
                            </div>
